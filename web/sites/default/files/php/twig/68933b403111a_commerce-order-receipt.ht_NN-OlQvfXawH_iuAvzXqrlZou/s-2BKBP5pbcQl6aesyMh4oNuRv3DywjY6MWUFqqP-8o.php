...
class __TwigTemplate_e7f6d9b201d1e455b621fa48b4c948c7 extends Template
{
  ...
  <tr>
    <td>
      <table style=\"margin-left: auto; margin-right: auto; max-width: 768px; text-align: center;\">
        ...
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["order_entity"] ?? null), "getStore", [], "any", false, false, true, 31), "label", [], "any", false, false, true, 31), "html", null, true);
        yield "</a>
          </td>
        </tr>
        </tbody>
      ...
      <table style=\"text-align: center; min-width: 450px; margin: 5px auto 0 auto; border: 1px solid #cccccc; border-radius: 5px; padding: 40px 30px 30px 30px;\">
        ...
        yield "Order number:";
        yield "</span> ";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["order_entity"] ?? null), "getOrderNumber", [], "any", false, false, true, 43), "html", null, true);
        yield "</div>
            ";
        // line 44
        if (CoreExtension::getAttribute($this->env, $this->source, ($context["order_entity"] ?? null), "getPlacedTime", [], "any", false, false, true, 44)) {
            ...
            yield "Order date:";
            yield "</span> ";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->env->getFilter('format_date')->getCallable()(CoreExtension::getAttribute($this->env, $this->source, ($context["order_entity"] ?? null), "getPlacedTime", [], "any", false, false, true, 45), "short"), "html", null, true);
            yield "</div>
            ";
        }
        // line 47
        ...
        <tr>
          <td>
            <p style=\"margin-bottom: 0;\">
              ";
        // line 119
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("Subtotal: @subtotal", ["@subtotal" => $this->extensions['Drupal\commerce_price\TwigExtension\PriceTwigExtension']->formatPrice(CoreExtension::getAttribute($this->env, $this->source, ($context["totals"] ?? null), "subtotal", [], "any", false, false, true, 119))]));
        yield "
            </p>
          </td>
        </tr>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["adjustment"]) {
          ...
          <td>
            <p style=\"margin-bottom: 0;\">
              ";
            // line 127
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["adjustment"], "label", [], "any", false, false, true, 127), "html", null, true);
            yield ": ";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\commerce_price\TwigExtension\PriceTwigExtension']->formatPrice(CoreExtension::getAttribute($this->env, $this->source, $context["adjustment"], "total", [], "any", false, false, true, 127)), "html", null, true);
            yield "
            </p>
          </td>
        </tr>
        ...
        yield "        <tr>
          <td>
            <p style=\"font-size: 24px; padding-top: 15px; padding-bottom: 5px;\">
              ";
        // line 135
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("Order Total: @total", ["@total" => $this->extensions['Drupal\commerce_price\TwigExtension\PriceTwigExtension']->formatPrice(CoreExtension::getAttribute($this->env, $this->source, ($context["order_entity"] ?? null), "getTotalPrice", [], "any", false, false, true, 135))]));
        yield "
            </p>
          </td>
        </tr>
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, ($context["order_entity"] ?? null), "getCustomerComments", [], "any", false, false, true, 139)) {
            ...
            yield "</td>
                ...
                <tr>
                  <td><p>";
            // line 148
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(CoreExtension::getAttribute($this->env, $this->source, ($context["order_entity"] ?? null), "getCustomerComments", [], "any", false, false, true, 148));
            yield "</p></td>
                </tr>
                </tbody>
              </table>
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["order_item"]) {
            ...
            yield "              <tr>
                <td>
                  ";
            // line 57
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Twig\Extension\CoreExtension']->formatNumber(CoreExtension::getAttribute($this->env, $this->source, $context["order_item"], "getQuantity", [], "any", false, false, true, 57)), "html", null, true);
            yield " x
                </td>
                <td>
                  <span>";
            // line 60
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["order_item"], "label", [], "any", false, false, true, 60), "html", null, true);
            yield "</span>
                  <span style=\"float: right;\">";
            // line 61
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\commerce_price\TwigExtension\PriceTwigExtension']->formatPrice(CoreExtension::getAttribute($this->env, $this->source, $context["order_item"], "getTotalPrice", [], "any", false, false, true, 61)), "html", null, true);
            yield "</span>
                </td>
              </tr>
              ";
    ...
    public function block_shipping_information(array $context, array $blocks = []): iterable
    {
        ...
        // line 87
        yield "                      ";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["shipping_information"] ?? null), "html", null, true);
        yield "
                    ";
        yield from [];
    }
    ...
    public function block_billing_information(array $context, array $blocks = []): iterable
    {
        ...
        // line 94
        yield "                      ";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["billing_information"] ?? null), "html", null, true);
        yield "
                    ";
        yield from [];
    }
    ...
    public function block_payment_method(array $context, array $blocks = []): iterable
    {
        ...
        // line 106
        yield "                      ";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["payment_method"] ?? null), "html", null, true);
        yield "
                    ";
        yield from [];
    }
    ...
    {
        return new Source("", "modules/contrib/commerce/modules/order/templates/commerce-order-receipt.html.twig", "/Applications/MAMP/htdocs/projects/crackers/web/modules/contrib/commerce/modules/order/templates/commerce-order-receipt.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = ["if" => 44, "block" => 51, "for" => 123];
        static $filters = ["escape" => 31, "t" => 39, "format_date" => 45, "commerce_price_format" => 119, "raw" => 148, "number_format" => 57];
